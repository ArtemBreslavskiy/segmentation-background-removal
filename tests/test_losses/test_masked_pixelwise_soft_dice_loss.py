...
class TestMaskedPixelwiseSoftDiceLoss:
    ...
    def test_loss_different_smooth(self, smooth):
        ...
        loss_zero = loss_function(pred_ones, target_ones)
        loss_ones = loss_function(pred_ones, target_zeros)
    ...
    def test_loss_extreme_value(self):
        ...
        assert 0 <= loss_zero_1.item() <= 1
        assert 0 <= loss_zero_2.item() <= 1
    ...
    def test_loss_different_smooth_with_valid_mask(self, smooth):
        ...
        loss_zero = loss_function(pred_ones, target_ones, valid_mask)
        loss_ones = loss_function(pred_ones, target_zeros, valid_mask)
